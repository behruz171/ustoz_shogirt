...
async def set_location(message: types.Message, state: FSMContext):
    text = "Tolov qilasizmi yoki Tekinmi?\nKerak bo`lsa, Summani kiriting?"
...
async def set_price(message: types.Message, state: FSMContext):
    if pattern1.match(message.text):
        ...
        await message.answer(text="Summani kiriting")
...
async def set_oclock(message: types.Message, state: FSMContext):
    text = "🔎 Maqsad: Maqsadingizni qisqacha yozib bering."
